...
class MasterWriter(DBStorage):
    ...
    def master(self, df_master: pl.DataFrame) -> None:
        """Store the master"""
...
class ReleaseWriter(DBStorage):
    ...
    def release(self, df_release: pl.DataFrame) -> None:
        """Store the release"""
    ...
    def credits(self, df_credits: pl.DataFrame) -> None:
