...
router_discogs = APIRouter(
    prefix='/discogs',
    tags=['Discogs resources']
)

@router_discogs.get("/check-credentials/")
...
@router_discogs.get("/get-user-access/")
...
@router_discogs.get("/receive-token/")
...
@router_discogs.get("/process_user_data/")
