...
Now... If you are still interested and want to try this project out yourself, let me warn you in advance: this will need patience. Loading the data takes looooong since all is collected with Discogs API calls which aren't the fastest way for ingesting data. Next to that the clustering takes quite some computing power, which at the time of this writing also means: more time.....
